...
Notice that the scoring geometry is technically independent of simulation geometry,
however in reality the scoring geometry will always be attached to the simulation geometry eventually.