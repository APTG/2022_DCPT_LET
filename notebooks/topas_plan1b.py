...
files = []
Dose = BinnedResult('data/topas/results/output/plan_1b/Scoring_protonD_YBox.csv')
LET = BinnedResult('data/topas/results/output/plan_1b/Scoring_protonLET_YBox.csv')
...
ax1.fill_between(x=[15.5, 20.5], y1=0, y2=max(np.squeeze(Dose.data['Sum']))*scale+1, facecolor='blue', alpha=0.1)
...
# plt.show()
plt.savefig("data/topas/results/plan_1b/" + Dose.quantity +"_" + LET.quantity)
