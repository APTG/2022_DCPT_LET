...
files = []
Dose = BinnedResult('data/topas/results/output/plan01_geoC_SOBP74/Scoring_protonD_YBox.csv')
LET = BinnedResult('data/topas/results/output/plan01_geoC_SOBP74/Scoring_protonLET_YBox.csv')
...
# plt.show()
plt.savefig("data/topas/results/plan01_geoC_SOBP74/" + Dose.quantity + "_" + LET.quantity)
