...
The gzipped binary files in the RSSA/SSW file format can be downloaded from the following locations. Each of the files is 2GB in size and contains roughly 10^8 particles. The files contain the list of particles scored at a plane close to the particle source, ~50 cm upstream of the isocenter on the source side (the same plane as the MCPL phase-space files — see [data/resources/phasespace](../resources/phasespace) and [docs/coordinates.md](../../docs/coordinates.md) for the sign convention).
